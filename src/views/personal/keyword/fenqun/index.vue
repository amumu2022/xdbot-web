...
<template>
  <div class="main">
    ...
    >
      ...
      <el-form-item label="群聊号码：" prop="group">
        <el-input
          v-model="form.group"
          placeholder="请输入群聊号码"
          clearable
      ...
      <el-form-item label="匹配类型：" prop="sendType">
        <el-select
          ...
          @change="onSearch()"
        >
          <el-option label="精确问答" value="1" />
          <el-option label="模糊问答" value="0" />
        </el-select>
      </el-form-item>
    ...
    <PureTableBar title="分群关键词列表" :columns="columns" @refresh="onSearch">
      <template #buttons>
        <el-button
          type="primary"
