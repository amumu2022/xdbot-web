...
<template>
  <div class="main">
    ...
    >
      ...
      <el-form-item label="卡密：" prop="skey">
        <el-input
          v-model="form.skey"
          placeholder="请输入卡密"
          clearable
      ...
      <el-form-item label="使用账号：" prop="user">
        <el-input
          v-model="form.user"
          placeholder="请输入使用账号"
          clearable
    ...
    <PureTableBar title="卡密信息" :columns="columns" @refresh="onSearch">
      <template #buttons>
        <el-button
          type="primary"
      ...
      <template v-slot="{ size, dynamicColumns }">
        ...
        >
          <template #operation="{ row }">
            ...
            />
            <el-popconfirm
              :title="`是否确认删除卡密编号为${row.id}的这条数据`"
