...
export const getFenqunInfo = () => {
  return http.request<ResultDetail>("get", "/api/account/fq/get_info");
};

/** 更新分群数据 */
export const UpdateFenqun = (data?: object | string) => {
  return http.request<ResultDetail>("put", `/api/account/fq/data/update`, {
    data
  });
};
...
export const UpdateFenqunTable = (data?: object | string) => {
  return http.request<ResultDetail>("put", `/api/account/fq/data/info`, {
    data
  });
};
...
export const getBotList = () => {
  return http.request<ResultDetail>("get", "/api/account/qj/get_bot");
};
...
export const getQuanjuInfo = (bot_id: string) => {
  return http.request<ResultDetail>(
    "get",
    `/api/account/qj/${bot_id}/getGlobalData`
  );
};
...
export const getGroupList = (bot_id: string, data?: object) => {
  return http.request<Result>(
    "post",
    `/api/account/${bot_id}/get_group_list`,
    { data }
  );
};
...
export const getGroupMemberList = (
  ...
  return http.request<Result>(
    "post",
    `/api/account/${bot_id}/${group_id}/get_group_member_list`,
    { data }
  );
};
...
export const setGroupLeave = (bot_id: string, group_id: string) => {
  return http.request<ResultDetail>(
    "get",
    `/api/bot/set_group_leave?bot_id=${bot_id}&group_id=${group_id}`
  );
};
...
export const setGroupSign = (bot_id: string, group_id: string) => {
  return http.request<ResultDetail>(
    "get",
    `/api/bot/set_group_sign?bot_id=${bot_id}&group_id=${group_id}`
  );
};
