...
export const getRoleList = (data?: object) => {
  return http.request<Result>("post", "/api/v1/admin/role/list", { data });
};

/** 角色添加 */
export const createRoleApi = (data?: object) => {
  return http.request<ResultDetail>("post", "/api/v1/admin/role/add", {
    data: data
  });
};
...
export const deleteRoleApi = userId => {
  const url = `/api/v1/admin/role/del/${userId}`;
  return http.request<ResultDetail>("delete", url);
};

/** 批量删除角色 */
export const BatchDelRole = (data?: object) => {
  return http.request<ResultDetail>("post", "/api/v1/admin/role/batch_remove", {
    data
  });
};
...
export const UpdateRole_status = userId => {
  const url = `/api/v1/admin/role/${userId}/status`;
