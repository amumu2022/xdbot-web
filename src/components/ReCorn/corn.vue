...
export default {
  ...
  methods: {
    ...
    submit() {
      const year = this.value_year ? " " + this.value_year : "";
      this.defaultValue =
        this.value_second +
        " " +
        this.value_minute +
